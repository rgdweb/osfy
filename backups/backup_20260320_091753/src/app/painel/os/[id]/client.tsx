...
interface OSDetailPageProps {
  os: OrdemServico & {
    ...
    loja: { slug: string; nome: string; telefone?: string; endereco?: string; cidade?: string; estado?: string }
  ...
  <div class="container">
    ...
    <div class="via">
      ...
      <div class="section">
        ...
        <div class="grid">
          ...
          <div class="field">
            ...
            <div class="field-value">${os.cliente.cpf}</div>
          </div>
          ` : ''}
          ${os.cliente.endereco ? `
          <div class="field">
            <div class="field-label">Endereço</div>
            <div class="field-value">${os.cliente.endereco}</div>
          </div>
          ` : ''}
        </div>
      </div>
      ...
      <div class="footer">
        ...
        ${os.codigoAcesso ? `<p style="font-weight: bold; font-size: 10px; margin-top: 3px;">Código de Acesso: ${os.codigoAcesso}</p>` : ''}
      </div>
    </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="border-slate-200">
            ...
            <CardContent className="space-y-2">
              ...
              {os.cliente.cpf && (
                <p className="text-slate-600">CPF: {os.cliente.cpf}</p>
              )}
              {os.cliente.email && (
                <p className="text-slate-600">{os.cliente.email}</p>
              )}
              {os.cliente.endereco && (
                <p className="text-slate-600">{os.cliente.endereco}</p>
              )}
            </CardContent>
          </Card>
          ...
          {os.codigoAcesso && (
            <Card className="border-slate-200 bg-emerald-50">
              ...
              <CardContent className="text-center">
                <p className="text-3xl font-bold text-emerald-700 tracking-widest">
                  {os.codigoAcesso}
                </p>
                <p className="text-sm text-emerald-600 mt-2">
                  Use este código para consultar sua OS
                </p>
              </CardContent>
            </Card>
          )}

...
import { Wrench, ArrowLeft, CheckCircle, MessageCircle, Lock, MapPin, Building, FileText, CreditCard, QrCode, Copy, ExternalLink } from 'lucide-react'
        ...
        <Card className="max-w-lg w-full text-center border-emerald-200">
          <CardHeader>
            ...
            <CardDescription className="text-base mt-2">
              Sua loja foi cadastrada com sucesso. Realize o pagamento para ativar.
            </CardDescription>
          </CardHeader>
              ...
              <>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left">
                  ...
                  <p className="text-blue-700 text-sm mb-3">
                    Inicie seu período de <strong>7 dias grátis</strong> para conhecer o sistema. Sem compromisso!
                  </p>

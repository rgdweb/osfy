...
const menuItems = [
  ...
  { href: '/superadmin/trials', label: 'Trials', icon: Gift },
  { href: '/superadmin/faturas', label: 'Faturas', icon: CreditCard },
  { href: '/superadmin/pagamentos', label: 'Pagamentos', icon: Wallet },
